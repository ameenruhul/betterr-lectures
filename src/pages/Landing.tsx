      ...
      <main>
        ...
        <section className="relative py-24 md:py-32 overflow-hidden bg-white">
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute -top-40 -right-40 w-80 h-80 bg-ai-purple/5 rounded-full blur-3xl"></div>
            <div className="absolute top-60 -left-20 w-60 h-60 bg-ai-magenta/5 rounded-full blur-3xl"></div>
            <div className="absolute bottom-20 right-20 w-40 h-40 bg-ai-violet/5 rounded-full blur-3xl"></div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-8 max-w-xl">
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <Button size="lg" variant="gradient" className="shadow-lg group transition-all">
                    <Link to="/login" className="flex items-center">
                      Start Free Trial 
                      <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
                    </Link>
                  </Button>
                  <Button size="lg" variant="outline" asChild className="border-2 gradient-border hover:scale-105 transition-transform">
              ...
              <div className="relative hidden md:block">
                <div className="absolute -z-10 -inset-0.5 bg-red-violet-gradient rounded-2xl blur-xl opacity-30"></div>
                <div className="relative animate-float p-2">
                  <div className="relative overflow-hidden rounded-2xl border border-white/20 backdrop-blur-sm glass-card shadow-2xl">
                    <div className="absolute inset-0 bg-gradient-to-tr from-ai-purple/5 to-ai-violet/10"></div>
                    <img 
                      src="/placeholder.svg" 
                      alt="Better Lectures Dashboard" 
                      className="w-full h-auto relative z-10" 
                    />
                    <div className="absolute bottom-4 left-4 right-4 p-4 rounded-xl bg-white/90 backdrop-blur-sm shadow-lg border border-white/50 animate-pulse-slow">
                ...
                <div className="absolute -bottom-10 -right-10 w-28 h-28 bg-violet-purple-gradient rounded-full blur-xl opacity-20 animate-pulse-slow"></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="features" className="py-20 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <FeatureCard 
                icon={<Book className="h-10 w-10 text-ai-purple" />}
                ...
                gradient="from-ai-purple/10 to-ai-magenta/10"
              />
              <FeatureCard 
              ...
              />
              <FeatureCard 
                icon={<Lightbulb className="h-10 w-10 text-ai-purple" />}
                ...
                gradient="from-ai-purple/10 to-ai-purple/10"
              />
              <FeatureCard 
                icon={<FileText className="h-10 w-10 text-ai-purple" />}
            ...
            <div className="mt-16 grid md:grid-cols-2 gap-12">
              <Card className="border border-gray-100 overflow-hidden shadow-lg hover:shadow-xl transition-shadow group">
                <CardContent className="p-8 relative">
                  <div className="absolute inset-0 bg-gradient-to-br from-white to-gray-50 opacity-50 group-hover:opacity-100 transition-opacity"></div>
                  <div className="relative z-10">
                    ...
                    <ul className="space-y-4">
                      <li className="flex gap-3 animate-fade-up" style={{ animationDelay: "100ms" }}>
                        <div className="mt-1 w-6 h-6 rounded-full bg-ai-purple/10 flex items-center justify-center flex-shrink-0">
                          <Clock className="h-3.5 w-3.5 text-ai-purple" />
                        </div>
                        <div>
                      ...
                      <li className="flex gap-3 animate-fade-up" style={{ animationDelay: "200ms" }}>
                        <div className="mt-1 w-6 h-6 rounded-full bg-ai-purple/10 flex items-center justify-center flex-shrink-0">
                      ...
                      <li className="flex gap-3 animate-fade-up" style={{ animationDelay: "300ms" }}>
                        <div className="mt-1 w-6 h-6 rounded-full bg-ai-purple/10 flex items-center justify-center flex-shrink-0">
                          <Sliders className="h-3.5 w-3.5 text-ai-purple" />
                        </div>
                        <div>
                ...
                <CardContent className="p-8 relative">
                  ...
                  <div className="relative z-10">
                    ...
                    <ul className="space-y-4">
                      <li className="flex gap-3 animate-fade-up" style={{ animationDelay: "100ms" }}>
                        <div className="mt-1 w-6 h-6 rounded-full bg-ai-purple/10 flex items-center justify-center flex-shrink-0">
                          <Award className="h-3.5 w-3.5 text-ai-purple" />
                        </div>
                        <div>
                      ...
                      <li className="flex gap-3 animate-fade-up" style={{ animationDelay: "300ms" }}>
                        <div className="mt-1 w-6 h-6 rounded-full bg-ai-purple/10 flex items-center justify-center flex-shrink-0">
                          <Bookmark className="h-3.5 w-3.5 text-ai-purple" />
                        </div>
                        <div>
        ...
        <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="border border-gray-100 overflow-hidden shadow-xl hover:shadow-2xl transition-shadow">
                <CardContent className="p-8 relative">
                  <div className="mb-6 w-14 h-14 rounded-2xl bg-red-violet-gradient flex items-center justify-center text-white shadow-lg transform transition-transform group-hover:scale-110">
              ...
              <Card className="border border-gray-100 overflow-hidden shadow-xl hover:shadow-2xl transition-shadow">
                <CardContent className="p-8 relative">
                  <div className="mb-6 w-14 h-14 rounded-2xl bg-magenta-violet-gradient flex items-center justify-center text-white shadow-lg transform transition-transform group-hover:scale-110">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <div className="flex items-center justify-center gap-3">
                ...
                <span className="ml-2 text-xs text-white bg-ai-purple px-2 py-0.5 rounded-full">Save 20%</span>
              </div>
            </div>
            ...
            <div className="mt-12 text-center">
              <p className="text-sm text-gray-600">
                Need a custom solution? <a href="#contact" className="text-ai-purple underline hover:text-ai-magenta transition-colors">Contact our education specialists</a>
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <Card className="border border-gray-100 shadow-lg hover:shadow-xl transition-all hover:translate-y-[-5px]">
                <CardContent className="p-8">
                  <div className="mb-6 w-14 h-14 rounded-full bg-gradient-to-br from-ai-purple to-ai-magenta flex items-center justify-center text-white">
                  ...
                  <Button variant="outline" className="w-full border-2 gradient-border group">
                ...
                <CardContent className="p-8">
                  ...
                  <Button variant="outline" className="w-full border-2 gradient-border group">
                    <a href="#" className="flex items-center justify-center gap-2">
                      ...
                      <PenTool className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
                    </a>
                  </Button>
                </CardContent>
              </Card>
        ...
        {/* CTA */}
        <section className="py-20 bg-violet-purple-gradient">
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-3xl mx-auto">
              <div className="mb-6 mx-auto w-20 h-20 bg-white/20 rounded-full flex items-center justify-center transform hover:scale-110 transition-transform">
              ...
              <Button size="lg" className="bg-white text-ai-purple hover:bg-white/90 shadow-xl hover:shadow-2xl transition-all hover:scale-105">
        ...
        <section id="contact" className="py-20 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
              <Card className="border border-gray-100 rounded-2xl shadow-lg hover:shadow-xl transition-all">
                <CardContent className="p-8">
              ...
              <Card className="border border-gray-100 rounded-2xl shadow-lg hover:shadow-xl transition-all">
                <CardContent className="p-8">
                  ...
                  <form className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <input 
                          type="text" 
                          id="name" 
                          className="w-full px-4 py-2 border border-gray-200 rounded-md focus:ring-ai-purple focus:border-ai-purple"
                    ...
                    <Button type="submit" variant="gradient" className="w-full shadow-md group">
...
const FeatureCard = ({ icon, title, description, gradient, highlighted = false }: { 
  ...
  return (
    <Card className={`border border-gray-100 shadow-lg hover:shadow-xl transition-all hover:translate-y-[-5px] ${highlighted ? 'ring-2 ring-ai-purple/20' : ''}`}>
      <CardContent className="p-6 relative z-10">
        ...
        <div className="feature-icon-bg w-fit mb-4 transform transition-transform hover:scale-110">{icon}</div>
...
const WorkflowStep = ({ number, title, description, icon }: {
  ...
  return (
    <div className="text-center p-6 border border-gray-100 rounded-2xl shadow-lg hover:shadow-xl transition-all relative group hover:translate-y-[-5px]">
      <div className="w-12 h-12 rounded-full bg-red-violet-gradient text-white flex items-center justify-center text-xl font-bold mx-auto mb-4 shadow-lg group-hover:scale-110 transition-transform">
        {number}
      </div>
      <h3 className="text-xl font-semibold mb-2 text-gradient-red-violet">{title}</h3>
      <p className="text-gray-600 mb-4">{description}</p>
      {icon && (
        <div className="hidden md:flex justify-center text-ai-purple opacity-60 group-hover:translate-x-2 transition-transform">
          {icon}
        </div>
      )}
    </div>
      ...
      <CardContent className="p-6 relative">
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="mt-auto pt-4 border-t flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-ai-purple to-ai-magenta flex items-center justify-center text-white text-sm font-bold">
              {name.charAt(0)}
            </div>
            <div>
...
const PricingCard = ({ 
  ...
  return (
    <Card className={`border border-gray-100 ${highlighted ? 'shadow-2xl scale-105 z-10' : 'shadow-lg'} transition-all relative overflow-hidden hover:translate-y-[-5px]`}>
      {highlighted && (
      ...
      <CardContent className={`p-8`}>
        ...
        <Button 
          ...
          className={`w-full shadow-md group ${buttonVariant === "gradient" ? "" : "border-2 gradient-border"}`}
        >
          {buttonText}
          <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
        </Button>
