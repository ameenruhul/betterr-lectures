...
import { ChevronDown, ChevronRight, Video, FileText, Presentation, BookOpen, Play, FolderOpen } from "lucide-react";
...
const LectureFolder = ({ 
  ...
  if (isGridView) {
    return (
      <div 
        className="border rounded-lg bg-white shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden h-full flex flex-col"
      ...
      >
        <div className="p-4 flex-1 cursor-pointer">
          ...
          <h3 className="font-medium text-lg mb-2 line-clamp-2">{lecture.title}</h3>
