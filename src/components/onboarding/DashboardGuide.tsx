            ...
            <div className="fixed top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 pointer-events-auto">
              <div className="bg-white rounded-xl p-6 shadow-xl max-w-md animate-fade-in">
                ...
                <p className="mb-4 text-gray-600">
                  This interactive guide will help you discover the pathway to creating engaging lectures, 
                  assessments, and teaching materials. Hover over elements to see guidance.
                </p>
            ...
            <Spotlight active={true} className="fixed z-50 pointer-events-none">
              <div className="pointer-events-auto">
                <CoachMark
                  ...
                  description="Begin your journey by creating a new course or lecture. This is the first step in the teaching pathway."
                  position="bottom"
                  onNext={handleNext}
                  onSkip={handleSkip}
                  className="w-80"
            ...
            <Spotlight active={true} className="fixed z-50 pointer-events-none">
              <div className="pointer-events-auto">
                <CoachMark
                  ...
                  description="Follow these steps to create your course: 1) Create course, 2) Plan lessons, 3) Prepare lectures, 4) Create assessments, 5) Build study guides"
                  position="top"
                  onNext={handleNext}
                  onSkip={handleSkip}
                  className="w-80"
        ...
        return (
          <>
            ...
            <Spotlight active={true} className="fixed z-50 pointer-events-none">
              <div className="pointer-events-auto">
                <CoachMark
                  title="Teaching Excellence Resources"
            ...
            <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 pointer-events-auto">
              <div className="bg-white rounded-xl p-6 shadow-xl max-w-md animate-scale-in">
                <div className="flex items-center mb-3">
                  ...
                  <h2 className="text-xl font-bold">Guide Complete!</h2>
                </div>
                <p className="mb-4 text-gray-600">
                  You now understand the pathway to create amazing teaching materials.
                  Remember, you can toggle guided mode at any time from the dashboard.
                </p>
                <div className="flex justify-end space-x-3 mt-6">
                  <Button onClick={() => {
                    skipOnboarding();
